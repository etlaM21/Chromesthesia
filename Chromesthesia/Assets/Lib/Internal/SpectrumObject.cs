...
public class SpectrumObject {
    ...
    public void updateRotation(){
        float angle = this.indexInRow * Mathf.PI * 2  / this.numberOfObjects;
        ...
        this.Object.transform.rotation = rot;
    }
    ...
    public Vector3[] tunnelMeshPoints(){
        Vector2 outerCirclePosLeft = calculateCirclePosition(this.numberOfObjects/4*3, this.numberOfObjects, this.radiusOuter);
        Vector2 outerCirclePosRight = calculateCirclePosition(this.numberOfObjects/4*3+1, this.numberOfObjects, this.radiusOuter);
        ...
        Vector2 innerCirclePosLeft = calculateCirclePosition(this.numberOfObjects/4*3, this.numberOfObjects, this.radiusOuter - (this.radiusOuter - this.radiusInner) * this.Amplitude);
        Vector2 innerCirclePosRight = calculateCirclePosition(this.numberOfObjects/4*3+1, this.numberOfObjects, this.radiusOuter - (this.radiusOuter - this.radiusInner) * this.Amplitude);
        ...
        Vector3[] result = new Vector3[]
        {
            outerPosLeft, outerPosRight, innerPosLeft, innerPosRight
        };
