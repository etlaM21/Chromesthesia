...
------ | ------ 
3D landscape generated by amplitudes of sound frequencies | **Visually pleasing, interesting** 3D landscape generated by amplitudes of sound frequencies
Working VR experience on the **Oculus Quest** | Smooth VR Experience on the **Oculus Quest**

- Proper representation of FFT like in DAW EQ
- Interactivity
  - Audio Manipulation with FX (reverb, delay, chorus)
  - Frequencypass or Soloing by player movement to frequency
- SoundCloud API integration to load songs
- Menu, Loading and Pause Screen
- Custom Models
